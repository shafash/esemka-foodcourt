function FloorPlan({ tables = [], selectedId, onSelect, disableReserved = true }) {
  return (
    <div className="floor-plan">
      <div className="floor-plan__legend">
        <span className="floor-plan__legend-item">
          <span className="floor-plan__legend-swatch" /> Available
        </span>
        <span className="floor-plan__legend-item">
          <span className="floor-plan__legend-swatch floor-plan__legend-swatch--reserved" /> Reserved
        </span>
        <span className="floor-plan__legend-item">
          <span className="floor-plan__legend-swatch floor-plan__legend-swatch--selected" /> Selected
        </span>
      </div>
