...
import { getCategories, deleteCategory } from "../../services/cetagory.service";
...
function CategoryList() {
  ...
  const columns = [
    { key: "name", header: "Category" },
    {
      ...
      header: "Description",
      render: (row) => (
        <span className="category-description-cell">{row.description || "-"}</span>
      ),
    },
    {
      key: "menuCount",
      header: "Menus",
      align: "center",
      render: (row) => <Badge variant="neutral">{row.menuCount}</Badge>,
    },
    {
      key: "createdAt",
      header: "Created At",
      ...
      >
        {isLoading ? (
          ...
          <EmptyState
            ...
            onAction={() => navigate("/category/create")}
          />
        )}
      </Card>
